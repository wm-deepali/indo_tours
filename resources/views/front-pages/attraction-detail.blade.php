...
@section('content')
  ...
  <main>
    <section class="detail-banner">
      <div class="container">
        <div class="grid">
          <a href="assets/images/attraction/kashmir1.jpg" data-fancybox="gallery1" class="item">
            <img loading="lazy" src="assets/images/attraction/kashmir1.jpg" alt="Dal Lake" />
          ...
          <a class="item" href="assets/images/attraction/kashmir2.jpg" data-fancybox="gallery2">
            <img loading="lazy" src="assets/images/attraction/kashmir2.jpg" alt="Gulmarg" />
            <div class="image-overlay">
              <h3>Gulmarg</h3>
              <span>Kashmir</span>
            </div>
          ...
          <a href="assets/images/attraction/kashmir3.jpg" data-fancybox="gallery3" class="item">
            <img loading="lazy" src="assets/images/attraction/kashmir3.jpg" alt="Pahalgam" />
            <div class="image-overlay">
              <h3>Pahalgam</h3>
              <span>Kashmir</span>
            </div>
          ...
          <a href="assets/images/attraction/kashmir4.jpg" data-fancybox="gallery4" class="item">
            <img loading="lazy" src="assets/images/attraction/kashmir4.jpg" alt="Sonamarg" />
            <div class="image-overlay">
              <h3>Sonamarg</h3>
              <span>Kashmir</span>
            </div>
          ...
          <a href="assets/images/attraction/kashmir5.jpg" data-fancybox="gallery5" class="item more-images">
            <img loading="lazy" src="assets/images/attraction/kashmir5.jpg" alt="Kashmir Attractions" />
          ...
          <!-- gallery_more -->
          <a href="assets/images/attraction/kashmir1.jpg" data-fancybox="gallery5"></a>
          <a href="assets/images/attraction/kashmir2.jpg" data-fancybox="gallery5"></a>
          <a href="assets/images/attraction/kashmir3.jpg" data-fancybox="gallery5"></a>
          <a href="assets/images/attraction/kashmir4.jpg" data-fancybox="gallery5"></a>
          <a href="assets/images/attraction/kashmir5.jpg" data-fancybox="gallery5"></a>
          ...
          <div class="swiper thirdSilder">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="trip_card">
                  <a href="listing-detail.html" target="_blank" class="img">
                    <img loading="lazy" src="assets/images/attraction/kashmir1.jpg" alt="Kashmir Essentials Package" />
                    <span class="save">Save INR 12,000</span>
                  </a>
                  ...
                  <div class="content">
                    ...
                    <h3>
                      <a href="listing-detail.html" target="_blank">Kashmir Essentials — Srinagar</a>
                    </h3>

                    <div class="innerSave">
                      <s>INR 42,000</s>
                      <span class="saveChip">Save INR 12,000</span>
                    </div>
                    <p class="price">INR 30,000</p>
              ...
              <div class="swiper-slide">
                <div class="trip_card">
                  <a href="listing-detail.html" target="_blank" class="img">
                    <img loading="lazy" src="assets/images/attraction/kashmir2.jpg" alt="Kashmir Honeymoon Package" />
                    <span class="save">Save INR 15,500</span>
                  </a>
                  ...
                  <div class="content">
                    ...
                    <h3>
                      <a href="listing-detail.html" target="_blank">Kashmir Honeymoon Special</a>
                    </h3>

                    <div class="innerSave">
                      <s>INR 55,500</s>
                      <span class="saveChip">Save INR 15,500</span>
                    </div>
                    <p class="price">INR 40,000</p>
              ...
              <div class="swiper-slide">
                <div class="trip_card">
                  <a href="listing-detail.html" target="_blank" class="img">
                    <img loading="lazy" src="assets/images/attraction/kashmir3.jpg" alt="Complete Kashmir Package" />
                    <span class="save">Save INR 20,000</span>
                  </a>
                  ...
                  <div class="content">
                    ...
                    <h3>
                      <a href="listing-detail.html" target="_blank">Complete Kashmir Experience</a>
                    </h3>

                    <div class="innerSave">
                      <s>INR 65,000</s>
                      <span class="saveChip">Save INR 20,000</span>
                    </div>
    ...
    <section class="detail-secA">
      <div class="grid">
        <div class="img">
          <img loading="lazy" src="assets/images/attraction/kashmir3.jpg" alt="Kashmir landscape" />
          <span class="img__tag">Kashmir Valley</span>
        </div>

        <div class="item-content">
          <div class="heading">
            <h3>About <span>Kashmir</span></h3>
          </div>
          <p>
            Kashmir is one of India's most beautiful travel destinations,
            surrounded by the majestic Himalayas and famous for its scenic
            landscapes, lakes, gardens and peaceful valleys.
          </p>
          <p>
            From the lively streets of Srinagar to the snow-covered slopes of
            Gulmarg and the beautiful valleys of Pahalgam, every part of
            Kashmir offers something different to explore.
          </p>
          <p>
            Whether you're looking for nature, adventure, culture or a
            relaxing getaway, Kashmir is a destination that can be easily
            included in a personalized travel itinerary.
          </p>
          ...
          <div class="info-row">
            <div class="info-item">
              ...
              <div>
                ...
                <span class="value">Jammu &amp; Kashmir, India</span>
              </div>
            </div>
            ...
            <div class="info-item">
              ...
              <div>
                <span class="label">Best Time</span>
                <span class="value">March – October</span>
              </div>
            </div>
            ...
            <div class="info-item">
              ...
              <div>
                ...
                <span class="value">Family, Couples &amp; Adventure</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="detail-secB">
      <div class="container">
        <div class="heading">
          <h3>Why Visit <span>Kashmir?</span></h3>
        ...
        <div class="grid">
          <div class="card">
            <div class="icon">
              <img loading="lazy" src="assets/icon/mount.png" />
            </div>
            <h4>Himalayan Landscapes</h4>
            <p>
              Experience spectacular mountain views, green valleys and
          ...
          <div class="card">
            <div class="icon">
              <img loading="lazy" src="assets/icon/lake.png" />
            </div>
            <h4>Dal Lake</h4>
            <p>
              Enjoy a traditional Shikara ride and experience the beauty of
              Srinagar's famous lake.
            </p>
          </div>

          <div class="card">
            <div class="icon">
              <img loading="lazy" src="assets/icon/marg.png" />
            </div>
            <h4>Gulmarg</h4>
            <p>
              Explore one of India's most popular mountain destinations, known
              for skiing and the Gulmarg Gondola.
            </p>
          </div>
          ...
          <div class="card">
            ...
            <h4>Pahalgam</h4>
            <p>
              Discover beautiful forests, rivers and mountain scenery in the
              peaceful valley of Pahalgam.
            </p>
          </div>

          <div class="card">
            <div class="icon">
              <img loading="lazy" src="assets/icon/garden.png" />
            </div>
            <h4>Mughal Gardens</h4>
            <p>
              Visit beautifully designed historic gardens including Nishat
              Bagh and Shalimar Bagh.
            </p>
          </div>

          <div class="card">
            <div class="icon">
              <img loading="lazy" src="assets/icon/adventures.png" />
            </div>
            <h4>Adventure</h4>
            <p>
              Enjoy activities such as skiing, trekking, cable-car rides and
              river experiences depending on the season.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="detail-secC">
      <div class="container">
        <div class="heading">
          ...
          <p>
            Discover the best experiences and adventures Kashmir has to offer.
          </p>
        </div>
        ...
        <div class="grid">
          <a href="javascript:void()" class="card">
            <div class="card__img">
              <img loading="lazy" src="assets/images/attraction/kashmir1.jpg" alt="Shikara Ride on Dal Lake" />
              <span class="num">01</span>
              <span class="duration">1–2 Hours</span>
            </div>
            <div class="card__body">
              <h4>Shikara Ride on Dal Lake</h4>
              <p>
                Take a peaceful Shikara ride across Dal Lake and enjoy views
                of the surrounding mountains, houseboats and floating markets.
              </p>
              <button class="btn btn-outline-primary" type="button">
                Enquire Now
              </button>
          ...
          <a href="javascript:void()" class="card">
            <div class="card__img">
              <img loading="lazy" src="assets/images/attraction/kashmir2.jpg" alt="Explore Gulmarg" />
              <span class="num">02</span>
              <span class="duration">1 Day</span>
            </div>
            <div class="card__body">
              <h4>Explore Gulmarg</h4>
              <p>
                Visit Gulmarg for beautiful mountain scenery, outdoor
                activities and one of the world's highest cable-car
                experiences.
              </p>
              <button class="btn btn-outline-primary" type="button">
                Enquire Now
          ...
          <a href="javascript:void()" class="card">
            <div class="card__img">
              <img loading="lazy" src="assets/images/attraction/kashmir3.jpg" alt="Visit Pahalgam" />
              <span class="num">03</span>
              <span class="duration">1 Day</span>
            </div>
            <div class="card__body">
              <h4>Visit Pahalgam</h4>
              <p>
                Explore the scenic valleys, rivers and forests of Pahalgam,
                one of Kashmir's most popular mountain destinations.
              </p>
              <button class="btn btn-outline-primary" type="button">
                Enquire Now
              </button>
          ...
          <a href="javascript:void()" class="card">
            <div class="card__img">
              <img loading="lazy" src="assets/images/attraction/kashmir4.jpg" alt="Visit Mughal Gardens" />
            ...
            <div class="card__body">
              ...
              <p>
                Walk through Kashmir's historic Mughal gardens and enjoy
                beautifully landscaped grounds, fountains and mountain views.
              </p>
              <button class="btn btn-outline-primary" type="button">
                Enquire Now
              </button>
          ...
          <a href="javascript:void()" a class="card">
            <div class="card__img">
              <img loading="lazy" src="assets/images/attraction/kashmir5.jpg" alt="Ride the Gulmarg Gondola" />
              <span class="num">05</span>
              <span class="duration">2–4 Hours</span>
            </div>
            <div class="card__body">
              <h4>Ride the Gulmarg Gondola</h4>
              <p>
                Take the cable car toward the higher slopes of Gulmarg for
                spectacular views of the surrounding Himalayan landscape.
              </p>
              <button class="btn btn-outline-primary" type="button">
                Enquire Now
              </button>
          ...
          <a href="javascript:void()" class="card">
            <div class="card__img">
              <img loading="lazy" src="assets/images/attraction/kashmir3.jpg" alt="Explore Srinagar" />
              <span class="num">06</span>
              <span class="duration">Half Day</span>
            </div>
            <div class="card__body">
              <h4>Explore Srinagar</h4>
              <p>
                Discover Srinagar's old city, local markets, traditional
                architecture and famous lakeside attractions.
              </p>
              <button class="btn btn-outline-primary" type="button">
                Enquire Now
              </button>
    ...
    <section class="detail-secE">
      <div class="container">
        <div class="heading">
          <h3>Places to <span>Visit in Kashmir</span></h3>
          <p>
            Handpicked destinations across the valley, each with its own
            character.
          </p>
        </div>
              ...
              <div class="swiper-slide">
                <a href="javascript:void()" class="place-card">
                  <div class="place-card__image">
                    <img loading="lazy" src="assets/images/attraction/kashmir1.jpg" alt="Srinagar" />
                    <span class="place-card__tag">Kashmir</span>
                  </div>
                  ...
                  <div class="place-card__body">
                    ...
                    <p>
                      The cultural heart of Kashmir, famous for Dal Lake,
                      gardens, houseboats and historic neighbourhoods.
                    </p>
              ...
              <div class="swiper-slide">
                <a href="javascript:void()" class="place-card">
                  ...
                  <div class="place-card__body">
                    ...
                    <p>
                      A beautiful mountain resort known for skiing, meadows
              ...
              <div class="swiper-slide">
                <a href="javascript:void()" class="place-card">
                  ...
                  <div class="place-card__body">
                    ...
                    <p>
                      A peaceful valley surrounded by forests, rivers and
                      mountains.
                    </p>
              ...
              <div class="swiper-slide">
                <a href="javascript:void()" class="place-card">
                  ...
                  <div class="place-card__body">
                    ...
                    <p>
                      Known for its dramatic mountain scenery, glaciers and
    ...
    <section class="detail-secD">
      <div class="container">
        <div class="heading">
          ...
          <p>
            This is especially useful for your website — pick a pace and we'll
            build the route.
          </p>
        </div>
        ...
        <div class="grid">
          <div class="plan-card">
            ...
            <h4>Srinagar Highlights</h4>
            <div class="route">
              <span>Dal Lake</span>
              <span class="arrow">→</span>
              <span>Mughal Gardens</span>
              <span class="arrow">→</span>
              <span>Srinagar Sightseeing</span>
            </div>
          </div>
          ...
          <div class="plan-card">
            ...
            <h4>Complete Kashmir Experience</h4>
            <div class="route">
              <span>Srinagar</span>
              <span class="arrow">→</span>
              <span>Gulmarg</span>
        ...
        <div class="cta">
          ...
          <button class="btn btn-primary" type="button">
            Build My Kashmir Trip
          </button>
        </div>
      </div>
    </section>

    <!-- ================= OFFER BANNER — MANDATORY ================= -->
      ...
      <div class="container">
        <div class="group-offer-banner__inner">
          <div class="group-offer-banner__content">
            ...
            <h3>Book Your Kashmir &amp; Ladakh Trip Early — Save Up to 40%</h3>

            <p>
              Grab early-booking discounts, seasonal deals and free add-on
              experiences before this offer ends.
            </p>
          ...
          <div class="group-offer-banner__media">
            <div class="group-offer-banner__img group-offer-banner__img--secondary">
              <img loading="lazy" src="assets/images/home/party.jpg" alt="Travellers enjoying their trip" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="detail-secF">
      <div class="container">
        <div class="heading">
          <h3>Kashmir <span>Travel Information</span></h3>
          <p>
        ...
        <div class="season-strip">
          ...
          <div class="season-grid">
            <div class="season-card">
              <span class="season-card__months">Mar – May</span>
              <h5>Spring</h5>
              <p>
                Tulip gardens bloom and the valley turns green after winter
                snow melts.
              </p>
              <div class="tags">
                <span>Gardens</span><span>Fewer crowds</span>
              </div>
            </div>

            <div class="season-card is-active">
              <span class="season-card__months">Jun – Aug</span>
              <h5>Summer</h5>
              <p>
                Pleasant weather, ideal for Dal Lake, Gulmarg meadows and
                Pahalgam valleys.
              </p>
              <div class="tags">
                <span>Lakes</span><span>Sightseeing</span>
              </div>
            </div>

            <div class="season-card">
              <span class="season-card__months">Sep – Nov</span>
              <h5>Autumn</h5>
              <p>
                Chinar leaves turn gold and red — one of the most photogenic
                times to visit.
              </p>
              <div class="tags">
                <span>Foliage</span><span>Photography</span>
              </div>
            </div>

            <div class="season-card">
              <span class="season-card__months">Dec – Feb</span>
              <h5>Winter</h5>
              <p>
                Snow blankets Gulmarg, drawing skiers and snowboarders from
                across the world.
              </p>
              <div class="tags"><span>Skiing</span><span>Snowfall</span></div>
            </div>
          </div>
        </div>
          ...
          <div class="ticket-grid">
            <div class="ticket">
              <div class="ticket__top">
                ...
                <div>
                  <p class="mode-name">By Air</p>
                  <p class="mode-sub">Srinagar Airport (SXR)</p>
                </div>
              </div>
              <div class="ticket__divider"></div>
              <div class="ticket__body">
                <p>
                  Srinagar Airport is the main gateway to the region, with
                  regular flights connecting Delhi, Mumbai and other major
                  Indian cities.
                </p>
              </div>
            </div>
            ...
            <div class="ticket">
              <div class="ticket__top">
                ...
                <div>
                  <p class="mode-name">By Road</p>
                  <p class="mode-sub">NH44 highway</p>
                </div>
              </div>
              <div class="ticket__divider"></div>
              <div class="ticket__body">
                <p>
                  Kashmir is connected to major cities in North India by road,
                  with scenic mountain drives through Jammu.
                </p>
              </div>
            </div>
            ...
            <div class="ticket">
              <div class="ticket__top">
                ...
                <div>
                  <p class="mode-name">By Train</p>
                  <p class="mode-sub">Jammu Tawi station</p>
                </div>
              </div>
              <div class="ticket__divider"></div>
              <div class="ticket__body">
                <p>
                  The railway network connects parts of the region, with
                  onward travel to Srinagar completed by road.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="budget-block">
          ...
          <div class="pkg-grid">
            <div class="pkg-card">
              <span class="pkg-card__tier">Budget</span>
              <p class="pkg-card__price">
                ₹2,000 – ₹4,000 <span>/ day</span>
              </p>
              <p class="pkg-card__note">
                Good for solo travellers and backpackers
              </p>
              <ul class="pkg-card__features">
                <li><span class="check">✓</span>Guesthouses and homestays</li>
                <li><span class="check">✓</span>Shared local transport</li>
                <li><span class="check">✓</span>Local dhaba meals</li>
                <li><span class="check">✓</span>Self-planned sightseeing</li>
              </ul>
            </div>

            <div class="pkg-card is-recommended">
              <span class="pkg-card__tier">Mid-range</span>
              <p class="pkg-card__price">
                ₹4,000 – ₹8,000 <span>/ day</span>
              </p>
              <p class="pkg-card__note">
              ...
              <ul class="pkg-card__features">
                <li>
                  <span class="check">✓</span>3-star hotels or deluxe
                  houseboats
                </li>
                <li>
                  <span class="check">✓</span>Private cab for sightseeing
                </li>
                <li>
                  <span class="check">✓</span>Mix of local and multi-cuisine
                  meals
                </li>
                <li><span class="check">✓</span>Guided day trips included</li>
              </ul>
            </div>

            <div class="pkg-card">
              <span class="pkg-card__tier">Premium</span>
              <p class="pkg-card__price">₹8,000+ <span>/ day</span></p>
              <p class="pkg-card__note">
                For a fully curated, comfort-first trip
              </p>
              <ul class="pkg-card__features">
                <li>
                  <span class="check">✓</span>Luxury resorts and premium
                  houseboats
                </li>
                <li>
                  <span class="check">✓</span>Private car with driver, full
                  trip
                </li>
                <li>
                  <span class="check">✓</span>Curated dining experiences
                </li>
                <li>
                  <span class="check">✓</span>Personal guide and priority
                  bookings
                </li>
              </ul>
            </div>
        ...
        <div class="carry-block">
          ...
          <div class="carry-grid">
            <div class="carry-group">
              <p class="carry-group__title">Clothing & Footwear</p>
              <ul>
                <li><span class="dot"></span>Comfortable walking shoes</li>
                <li><span class="dot"></span>Light jacket</li>
                <li><span class="dot"></span>Weather-appropriate clothing</li>
              </ul>
            </div>

            <div class="carry-group">
              <p class="carry-group__title">Essentials</p>
              <ul>
                <li><span class="dot"></span>Sunglasses</li>
                <li><span class="dot"></span>Sunscreen</li>
                <li><span class="dot"></span>Power bank and adapter</li>
              </ul>
            </div>

            <div class="carry-group">
              <p class="carry-group__title">Health & Safety</p>
              <ul>
                <li><span class="dot"></span>Personal medicines</li>
                <li><span class="dot"></span>Basic first-aid kit</li>
                <li><span class="dot"></span>Reusable water bottle</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section class="detail-secG">
      <div class="container">
        <div class="heading">
          <h3>Where is <span>Kashmir?</span></h3>
          <p>
            Discover Kashmir’s location, surroundings, and the best gateway to
            the region.
          </p>
        </div>

        <div class="map-wrap">
          <iframe src="https://www.google.com/maps?q=Kashmir,Jammu%20and%20Kashmir,India&output=embed" loading="lazy"
        ...
        <div class="map-footer">
          <div class="map-location">
            ...
            <p>Kashmir, Jammu &amp; Kashmir, India</p>
          </div>

          <a href="https://www.google.com/maps/dir/?api=1&destination=Kashmir,Jammu%20and%20Kashmir,India" target="_blank"
      ...
      <div class="container">
        <div class="app-promo-inner">
          <div class="app-promo-text">
            ...
            <h3>Ready to Explore Kashmir?</h3>
            <p>
              Create your personalized Kashmir itinerary and discover the best
              places, experiences and attractions based on your travel style.
            </p>
          ...
          <div class="app-promo-visual">
            <div class="phone phone--back">
              <img loading="lazy" src="assets/icon/h3-destination-shape.png" alt="App preview" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="swiper thirdSilder">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="trip_card">
                  <a href="listing-detail.html" target="_blank" class="img">
                    <img loading="lazy" src="assets/images/blog/manali.jpg" alt="Manali Tour Package" />
              ...
              <div class="swiper-slide">
                <div class="trip_card">
                  <a href="listing-detail.html" target="_blank" class="img">
                    <img loading="lazy" src="assets/images/blog/beach.jpg" alt="Leh Ladakh Tour Package" />
              ...
              <div class="swiper-slide">
                <div class="trip_card">
                  <a href="listing-detail.html" target="_blank" class="img">
                    <img loading="lazy" src="assets/images/blog/mount.jpg" alt="Shimla Tour Package" />
    ...
    <section class="detail-secI">
      <div class="container">
        ...
        <div class="swiper-wrap">
          <div class="swiper fourSilder">
            <div class="swiper-wrapper">
              <!-- Manali -->
              <div class="swiper-slide">
                <a href="javascript:void()" class="journey_card">
                  <div class="img">
                  ...
                  <div class="content">
                    <h5>Manali</h5>
                    <p>Snowy mountains, valleys and adventure experiences.</p>
                  </div>
                </a>
              </div>
              ...
              <div class="swiper-slide">
                <a href="javascript:void()" class="journey_card">
                  <div class="img">
                    <img loading="lazy" src="assets/images/blog/beach.jpg" alt="Leh Ladakh" />
                  </div>

                  <div class="content">
                    <h5>Leh</h5>
                    <p>
                      High-altitude landscapes and unforgettable Himalayan
                      journeys.
                    </p>
                  </div>
                </a>
              ...
              <div class="swiper-slide">
                <a href="javascript:void()" class="journey_card">
                  <div class="img">
                    <img loading="lazy" src="assets/images/blog/mount.jpg" alt="Shimla mountains" />
                  </div>

                  <div class="content">
                    <h5>Shimla</h5>
                    <p>
                      Colonial charm, mountain views and peaceful hill
                      escapes.
                    </p>
                  </div>
                </a>
              ...
              <div class="swiper-slide">
                <a href="javascript:void()" class="journey_card">
                  ...
                  <div class="content">
                    <h5>Goa</h5>
                    <p>
                      Beaches, nightlife and relaxing coastal experiences.
                    </p>
                  </div>
                </a>
              </div>
              ...
              <div class="swiper-slide">
                <a href="javascript:void()" class="journey_card">
                  ...
                  <div class="content">
                    <h5>Kashmir</h5>
                    <p>
                      Scenic valleys, serene lakes and breathtaking Himalayan
                      views.
                    </p>
                  </div>
                </a>
        ...
        <div class="center-btn">
          <a href="attractions.html" class="btn btn-primary">
    ...
    <section class="more-about">
      <div class="container">
        <div class="heading">
          <h3>More About <span>Dal Lake</span></h3>
          <p>
            Explore nearby places, activities and tour packages for your trip.
          </p>
        </div>

        <div class="rte-content">
          <h4>About Dal Lake</h4>

          <p>
            Dal Lake is one of the most popular attractions in
            <a href="javascript:void(0)">Srinagar</a>, known for its beautiful
            surroundings, traditional houseboats and peaceful lake
            experiences. It is an important highlight for travellers exploring
            <a href="javascript:void(0)">Kashmir</a>.
          </p>

          <p>
            Visitors can include Dal Lake in their
            <a href="javascript:void(0)">Kashmir Tour Packages</a>
            and explore other popular places across the region.
          </p>

          <h4>Things to Do at Dal Lake</h4>

          <ul>
            <li>
              Enjoy a peaceful
              <a href="javascript:void(0)">Shikara Ride</a>
              across the lake.
            </li>

            <li>Explore traditional houseboats and floating markets.</li>

            <li>Capture beautiful views of the surrounding mountains.</li>

            <li>
              Explore nearby
              <a href="javascript:void(0)">Srinagar Attractions</a>
              and cultural landmarks.
            </li>
          </ul>

          <h4>Explore More Kashmir Attractions</h4>

          <p>
            If you are exploring Kashmir, you can also visit
            <a href="javascript:void(0)">Gulmarg</a>,
            <a href="javascript:void(0)">Pahalgam</a> and
            <a href="javascript:void(0)">Sonamarg</a>. These destinations
            offer scenic landscapes, outdoor experiences and memorable
            sightseeing opportunities.
          </p>

          <h4>Recommended Tour Packages</h4>

          <p>
            Plan your visit with our
            <a href="javascript:void(0)">Kashmir Tour Packages</a>
            designed around popular destinations and attractions. Families can
            explore our
            <a href="javascript:void(0)">Family Tour Packages</a>, while
            couples can discover our
            <a href="javascript:void(0)">Honeymoon Packages</a>. Adventure
            seekers can also explore our
            <a href="javascript:void(0)">Adventure Tour Packages</a>.
          </p>

          <h4>Explore More Travel Experiences</h4>

          <p>
            Looking for more places and experiences? Browse our
            <a href="javascript:void(0)">Destinations</a>, discover more
            <a href="javascript:void(0)">Attractions</a>, explore exciting
            <a href="javascript:void(0)">Activities</a>
            and read our latest
            <a href="javascript:void(0)">Travel Guides</a>
            before planning your journey.
          </p>

          <blockquote>
            <p>
              "The best attractions become unforgettable when you experience
              them, not just visit them."
            </p>
          </blockquote>

          <h4>Plan Your Kashmir Trip</h4>

          <p>
            Make the most of your journey by exploring nearby attractions and
            experiences. Browse our
            <a href="javascript:void(0)">Tour Packages</a>
            and discover more travel ideas with
            <a href="javascript:void(0)">IND Tour Adventure</a>.
          </p>
        </div>
      </div>
    </section>
        ...
        <div class="accordion-wrapper">
          ...
          <div class="accordion-item">
            <div class="accordion-body">
              ...
              <div class="accordion-content">
                <p>
                  The best time depends on your interests. March to October is
                  popular for sightseeing and pleasant weather, while winter
                  is preferred for snow and skiing.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <div class="accordion-body">
              ...
              <div class="accordion-content">
                <p>
                  A 5–7 day trip is a good starting point for experiencing
                  major destinations such as Srinagar, Gulmarg and Pahalgam.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <div class="accordion-body">
              <div class="accordion-header">
                <h4>What are the must-visit places in Kashmir?</h4>
                <span class="accordion-icon">+</span>
              </div>

              <div class="accordion-content">
                <p>
                  Popular places include Srinagar, Dal Lake, Gulmarg, Pahalgam
                  and Sonamarg.
                </p>
              </div>
            </div>
          ...
          <div class="accordion-item">
            <div class="accordion-body">
              <div class="accordion-header">
                <h4>Is Kashmir suitable for families?</h4>
                <span class="accordion-icon">+</span>
              </div>

              <div class="accordion-content">
                <p>
                  Yes. Kashmir offers a mix of sightseeing, nature, relaxing
                  experiences and activities suitable for many types of family
                  trips.
                </p>
              </div>
            </div>
          ...
          <div class="accordion-item">
            <div class="accordion-body">
              <div class="accordion-header">
                <h4>What are the top things to do in Kashmir?</h4>
                <span class="accordion-icon">+</span>
              </div>

              <div class="accordion-content">
                <p>
                  Popular experiences include a Shikara ride on Dal Lake,
                  exploring Mughal gardens, enjoying the meadows of Gulmarg
                  and Pahalgam, and experiencing the scenic beauty of
                  Sonamarg.
                </p>
              </div>
            </div>
