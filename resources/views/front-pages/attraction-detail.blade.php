                ...
                <div class="trip_card">
                  <a href="listing-detail.html" target="_blank" class="img">
                    <img loading="lazy" src="{{ asset('assets/images/attraction/kashmir1.jpg') }}"
                      alt="Kashmir Essentials Package" />
        ...
        <div class="group-offer-banner__inner">
          <div class="group-offer-banner__content">
            ...
            <div class="group-offer-banner__actions">
              <a href="{{ $attraction->offer_button_url ?: route('listing') }}" class="btn btn-white">
      ...
      <div class="container">
        <div class="app-promo-inner">
          <div class="app-promo-text">
            ...
            <div class="cta-btns">
              <a href="{{ $attraction->promo_button_url ?: route('listing') }}" class="sbmt btn btn-white">
