...
@section('content')
    ...
    <section class="banner destination-banner">
        <div class="bg">
            ...
            <video autoplay="" muted="" loop="" playsinline="" class="bg-video" src="{{ asset('assets/video/trip3.mp4') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="package_card">
                                ...
                                <div class="content">
                                    ...
                                    <h5> <a href="destination-detail.html" target="_blank">Manali Mountain Escape</a></h5>
                        ...
                        <div class="swiper-slide">
                            <div class="package_card">
                                ...
                                <div class="content">
                                    ...
                                    <h5> <a href="destination-detail.html" target="_blank">Rajasthan Heritage Tour</a></h5>
    ...
    <section class="experience-sec">
        <div class="container">
            ...
            <div class="experience-grid">
                ...
                <!-- Beaches -->
                <a href="destination-detail.html" target="_blank" class="experience_card">
                    <img loading="lazy" src="{{ asset('assets/images/blog/beach.jpg') }}" alt="Beaches" loading="lazy" />
                ...
                <!-- Mountains -->
                <a href="destination-detail.html" target="_blank" class="experience_card">
                    <img loading="lazy" src="{{ asset('assets/images/blog/mount.jpg') }}" alt="Mountains" loading="lazy" />
                ...
                <!-- Wildlife -->
                <a href="destination-detail.html" target="_blank" class="experience_card">
                    <img loading="lazy" src="{{ asset('assets/images/blog/wild.avif') }}" alt="Wildlife" loading="lazy" />
    ...
    <section class="guides-sec">
        <div class="container">
            ...
            <div class="guides-grid">
                ...
                <a href="javascript:void()" class="guide_card">
                    <div class="img">
                        <img loading="lazy" src="{{ asset('assets/images/blog/goa.jpg') }}" alt="Top Things to Do in Goa"
                            loading="lazy" />
                    </div>
                    <div class="content">
