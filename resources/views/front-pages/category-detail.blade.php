    ...
    <main>
        ...
        @if($category->subCategories->isNotEmpty())
            <section class="listing-secA">
                <div class="container">
                    <div class="heading">
                        <h3>{{ $category->name }} <span>Categories</span></h3>
                        <p>
                            Explore the different {{ strtolower($category->name) }} categories we offer, each tailored to a
        ...
        @if($attractions->count())
            <section class="listing-secF">
                <div class="container">
                    <div class="heading">
                        <h3>Popular <span>{{ $category->name }} Attractions</span></h3>
                        @if($category->short_description)
                            <p>{{ $category->short_description }}</p>
                        @endif
                    </div>
        ...
        @if($reviews->count())
            <section class="listing-secD">
                <div class="container">
                    <div class="heading">
                        <h3>Loved by <span>{{ $category->name }} Travelers</span></h3>
                        <div class="swiper-group">
                    ...
                    <div class="grid">
                        <div class="rating_wrap">
                            ...
                            <a href="javascript:void()" class="review-link">
                                {{ number_format($reviews->count()) }} {{ $category->name }} Reviews
                            </a>

                            <p class="review-sub">by travelers who booked with us</p>
                        </div>
        ...
        <!-- HYPERLINK SECTION -->
        @if($category->subCategories->isNotEmpty() || $destinations->isNotEmpty() || $attractions->isNotEmpty() || $activities->isNotEmpty())
            <section class="seo-links-sec">
                <div class="container">
                    <div class="heading">
                        <h3>Explore More <span>{{ $category->name }}</span></h3>
                        <p>
                            {{ $category->short_description ?? 'Discover destinations, activities, attractions and travel experiences to plan your perfect trip.' }}
                        </p>
                    </div>
                    ...
                    <div class="seo-links-wrapper">
                        ...
                        @if($category->subCategories->isNotEmpty())
                            <div class="seo-link-block">
                                <h4>{{ $category->name }} Categories</h4>
                        ...
                        @if($destinations->isNotEmpty())
                            <div class="seo-link-block">
                                <h4>Popular {{ $category->name }} Destinations</h4>
                        ...
                        @if($attractions->isNotEmpty())
                            <div class="seo-link-block">
                                <h4>Top {{ $category->name }} Attractions</h4>
                        ...
                        @if($activities->isNotEmpty())
                            <div class="seo-link-block">
                                <h4>{{ $category->name }} Activities & Experiences</h4>
