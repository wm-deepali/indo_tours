                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="cat-tab-panel active" data-panel="general">
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="text" id="menu_name" name="menu_name" class="form-control-styled"
                                    value="{{ old('menu_name') }}" placeholder="Label shown in the navigation menu">
                            </div>
                            <div class="form-field">
                                <label for="sub_title">Sub Title</label>
                                <input type="text" id="sub_title" name="sub_title" class="form-control-styled"
                                    value="{{ old('sub_title') }}" placeholder="e.g. Discover Handpicked Escapes">
                            </div>
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="heading" name="heading" class="form-control-styled"
                                value="{{ old('heading') }}" placeholder="Main heading shown on the listing page">
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <div class="hint">Used on the listing card — max 2MB</div>
                            @error('image')
                            <div class="form-error">{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <textarea id="short_description" name="short_description" rows="2"
                                ...
                                placeholder="Shown on the category listing card">{{ old('short_description') }}</textarea>
                        </div>

                        <div class="form-field">
                            <label for="detail_content">Detail Content</label>
                            <textarea id="detail_content" name="detail_content" rows="8"
                                class="ckeditor form-control-styled"
                                placeholder="Full content shown on the category detail page">{{ old('detail_content') }}</textarea>
                    ...
                    <div class="cat-tab-panel" data-panel="listingsection">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="listing_eyebrow" name="listing_eyebrow" class="form-control-styled"
                                value="{{ old('listing_eyebrow') }}" placeholder="e.g. Europe Honeymoon">
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="text" id="listing_heading" name="listing_heading"
                                    class="form-control-styled" value="{{ old('listing_heading') }}"
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="listing_heading_highlight" name="listing_heading_highlight"
                                    class="form-control-styled" value="{{ old('listing_heading_highlight') }}"
                        ...
                        <div class="form-field">
                            ...
                            <textarea id="listing_intro" name="listing_intro" rows="3" class="form-control-styled"
                                placeholder="Short intro paragraph shown below the heading">{{ old('listing_intro') }}</textarea>
                        </div>
                        ...
                        <div class="form-row" style="margin-top:20px;">
                            <div class="form-field">
                                ...
                                <input type="text" id="listing_button_text" name="listing_button_text"
                                    class="form-control-styled" value="{{ old('listing_button_text') }}"
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="listing_button_url" name="listing_button_url"
                                    class="form-control-styled" value="{{ old('listing_button_url') }}"
                                    placeholder="/listing">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="text" id="listing_button2_text" name="listing_button2_text"
                                    class="form-control-styled" value="{{ old('listing_button2_text') }}"
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="listing_button2_url" name="listing_button2_url"
                                    class="form-control-styled" value="{{ old('listing_button2_url') }}"
                                    placeholder="/contact">
                            </div>
                        </div>
                    ...
                    <div class="cat-tab-panel" data-panel="cta">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="cta_title" name="cta_title" class="form-control-styled"
                                value="{{ old('cta_title') }}"
                                placeholder="e.g. Make Your Europe Honeymoon Unforgettable with Up to 50% Off">
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">Shown as bullet points — e.g. "Honeymoon Packages
                                Up to 50% Off"</div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="text" id="cta_button_text" name="cta_button_text"
                                    ...
                                    placeholder="View Honeymoon Packages">
                            </div>
                            <div class="form-field">
                    ...
                    <div class="cat-tab-panel" data-panel="promo">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="promo_badge_text" name="promo_badge_text" class="form-control-styled"
                                value="{{ old('promo_badge_text') }}" placeholder="Honeymoon Special">
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="promo_title" name="promo_title" class="form-control-styled"
                                ...
                                placeholder="e.g. Save up to INR 30,000 on selected packages">
                        </div>
                    ...
                    <div class="cat-tab-panel" data-panel="plansection">
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="text" id="plan_heading" name="plan_heading" class="form-control-styled"
                                    value="{{ old('plan_heading') }}" placeholder="e.g. Plan Your">
                            </div>
                            <div class="form-field">
                                ...
                                <input type="text" id="plan_heading_highlight" name="plan_heading_highlight"
                                    class="form-control-styled" value="{{ old('plan_heading_highlight') }}"
                        ...
                        <div class="form-field">
                            ...
                            <textarea id="plan_intro" name="plan_intro" rows="3"
                                class="form-control-styled">{{ old('plan_intro') }}</textarea>
                        </div>
                    ...
                    <div class="cat-tab-panel" data-panel="destinations">
                        ...
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">Duration, budget and best-time shown on the card
                                come from the Destination's own fields — order here sets slider order</div>
                        </div>
                    ...
                    <div class="cat-tab-panel" data-panel="attractions">
                        ...
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">Card details (duration, rating, review count,
                                image) come from the Attraction's own fields — order here sets slider order</div>
                        </div>
                    ...
                    <div class="cat-tab-panel" data-panel="seo">
                        ...
                        <div class="form-field">
                            ...
                            <div class="hint">Auto-fills from Category Name — edit anytime to override</div>
                            @error('h1')
                            <div class="form-error">{{ $message }}</div>@enderror
                        </div>
...
<script>
    ...
    (function focusFirstErrorTab() {
        ...
        document.querySelector('#category-tabs .cat-tab[data-tab="' + panel.dataset.panel + '"]').classList.add('active');
    })();
    ...
    document.getElementById('name').addEventListener('keyup', function () {
        ...
        if (!canonicalEdited) {
            document.getElementById('canonical_url').value = '{{ url('/category') }}/' + slug;
        }
        if (!h1Edited) {
