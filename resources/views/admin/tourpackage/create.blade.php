                ...
                <form action="{{ route('admin.tourpackages.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="cat-tab-panel active" data-panel="general">
                        ...
                        <div class="form-field">
                            ...
                            <select id="sub_category_id" name="sub_category_id" class="form-control-styled @error('sub_category_id') is-invalid @enderror" required>
                                ...
                                @foreach($subCategories as $sc)
                                    <option value="{{ $sc->id }}" {{ old('sub_category_id') == $sc->id ? 'selected' : '' }}>{{ $sc->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="slug" name="slug_preview" class="form-control-styled" readonly placeholder="Auto-generated from name">
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="text" id="duration_text" name="duration_text" class="form-control-styled" value="{{ old('duration_text') }}" placeholder="e.g. 6D / 5N">
                            </div>
                            <div class="form-field">
                                <label for="price_unit_text">Price Unit Text</label>
                                <input type="text" id="price_unit_text" name="price_unit_text" class="form-control-styled" value="{{ old('price_unit_text') }}" placeholder="e.g. Per Adult">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="number" step="0.01" id="old_price" name="old_price" class="form-control-styled" value="{{ old('old_price') }}" placeholder="e.g. 29500">
                            </div>
                            <div class="form-field">
                                <label for="price">Current Price (₹)</label>
                                <input type="number" step="0.01" id="price" name="price" class="form-control-styled" value="{{ old('price') }}" placeholder="e.g. 22900">
                            </div>
                        </div>

                        <div class="form-field">
                            <label for="video_url">Video URL</label>
                            <input type="text" id="video_url" name="video_url" class="form-control-styled" value="{{ old('video_url') }}" placeholder="e.g. assets/video/trip.mp4">
                        </div>
                    ...
                    <div class="cat-tab-panel" data-panel="banner">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="banner_tag_text" name="banner_tag_text" class="form-control-styled" value="{{ old('banner_tag_text') }}" placeholder="e.g. Explore Ladakh">
                        </div>

                        <div class="form-field">
                            <label for="banner_intro">Banner Intro</label>
                            <textarea id="banner_intro" name="banner_intro" rows="3" class="form-control-styled" placeholder="Discover breathtaking mountains, peaceful monasteries...">{{ old('banner_intro') }}</textarea>
                        </div>
                    ...
                    <div class="cat-tab-panel" data-panel="features">
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">e.g. "Transfers Included", "Stay Included", "Meals Included"</div>
                        </div>
                    </div>
                    ...
                    <div class="cat-tab-panel" data-panel="duration">
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">e.g. Image, Days Label: "4 days", Price: 14999</div>
                        </div>
                    </div>
                    ...
                    <div class="cat-tab-panel" data-panel="route">
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">e.g. "Leh" → "Nubra Valley" → "Pangong Tso" → "Leh" — order sets route sequence</div>
                        </div>
                    </div>
                    ...
                    <div class="cat-tab-panel" data-panel="overview">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="overview_title" name="overview_title" class="form-control-styled" value="{{ old('overview_title') }}" placeholder="e.g. About This Tour">
                        </div>

                        <div class="form-field">
                            <label for="overview_content">Overview Content</label>
                            <textarea id="overview_content" name="overview_content" rows="6" class="form-control-styled" placeholder="Full about-this-tour paragraph">{{ old('overview_content') }}</textarea>
                        </div>
                    ...
                    <div class="cat-tab-panel" data-panel="itinerary">
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">Order here sets display order — first day expands by default</div>
                        </div>
                    </div>
                    ...
                    <div class="cat-tab-panel" data-panel="hotels">
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">Star rating, images and location come from the selected Hotel's own record</div>
                        </div>
                    </div>
                    ...
                    <div class="cat-tab-panel" data-panel="policies">
                        <div class="form-field">
                            ...
                            <div class="hint" style="margin-top:10px;">e.g. "Confirmation Policy", "Refund Policy", "Cancellation Policy"</div>
                        </div>
                    </div>
                    ...
                    <div class="cat-tab-panel" data-panel="map">
                        <div class="form-field">
                            ...
                            <textarea id="map_embed_url" name="map_embed_url" rows="3" class="form-control-styled" placeholder="https://www.google.com/maps/embed?pb=...">{{ old('map_embed_url') }}</textarea>
                    ...
                    <div class="cat-tab-panel" data-panel="seo">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="meta_title" name="meta_title" class="form-control-styled" value="{{ old('meta_title') }}">
                        </div>

                        <div class="form-field">
                            <label for="meta_description">Meta Description</label>
                            <textarea id="meta_description" name="meta_description" rows="4" class="form-control-styled">{{ old('meta_description') }}</textarea>
                        </div>

                        <div class="form-field">
                            <label for="og_title">OG Title</label>
                            <input type="text" id="og_title" name="og_title" class="form-control-styled" value="{{ old('og_title') }}" placeholder="Auto-filled from Meta Title">
                            <div class="hint">Auto-fills from Meta Title — edit anytime to override</div>
                        </div>

                        <div class="form-field">
                            <label for="og_description">OG Description</label>
                            <textarea id="og_description" name="og_description" rows="3" class="form-control-styled" placeholder="Auto-filled from Meta Description">{{ old('og_description') }}</textarea>
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="canonical_url" name="canonical_url" class="form-control-styled" value="{{ old('canonical_url') }}" placeholder="Auto-generated from slug">
                        </div>
