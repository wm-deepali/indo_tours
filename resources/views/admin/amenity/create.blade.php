{{-- resources/views/admin/amenity/create.blade.php --}}
                ...
                <form action="{{ route('admin.amenities.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                value="{{ old('name') }}" placeholder="e.g. Transfers Included" required>
                        ...
                        <div class="form-field">
                            ...
                            <div class="hint">Small square icon — PNG / JPG / WEBP, max 1MB</div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-primary-dash">
                            <i class="fa fa-check"></i> Save Amenity
                        </button>
