                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <label class="checkbox-row">
                                    <input type="checkbox" name="show_in_header" value="1" {{ old('show_in_header', $subCategory->show_in_header) ? 'checked' : '' }}>
                                    Show in header menu accordion
                                </label>
                                <div class="hint">Lists this sub category's packages as an accordion in the India /
                            ...
                            <div class="form-field">
                                ...
                                <input type="number" min="0" id="header_sort_order" name="header_sort_order"
                                    ...
                                    value="{{ old('header_sort_order', $subCategory->header_sort_order) }}">
