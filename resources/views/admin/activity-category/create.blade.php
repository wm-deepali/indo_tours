...
<div class="main-section">
    ...
    <style>
        ...
        .form-field:first-of-type { padding-top: 24px; }
                ...
                <form action="{{ route('admin.activity-categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            value="{{ old('name') }}" placeholder="e.g. Adventure, Sightseeing, Water Sports" required>
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="form-control-styled">{{ old('description') }}</textarea>
                    </div>
