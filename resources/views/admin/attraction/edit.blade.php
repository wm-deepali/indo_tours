                ...
                <form action="{{ route('admin.attractions.update', $attraction) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="cat-tab-panel active" data-panel="general">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="slug" class="form-control-styled" readonly value="{{ $attraction->slug }}">
                        ...
                        <div class="form-field">
                            ...
                            @if($attraction->image)
                                <img src="{{ asset('storage/' . $attraction->image) }}" class="current-img-preview" alt="{{ $attraction->name }}">
                            @endif
                    ...
                    <div class="cat-tab-panel" data-panel="seo">
                        ...
                        <div class="form-field">
                            ...
                            @if($attraction->og_image)
                                <img src="{{ asset('storage/' . $attraction->og_image) }}" class="current-img-preview" alt="">
                            @endif
