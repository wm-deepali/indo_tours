{{-- resources/views/admin/blog-category/create.blade.php --}}
                    ...
                    <div style="padding:24px;">
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="text" id="name" name="name"
                                    ...
                                    value="{{ old('name') }}" placeholder="e.g. Dubai" required>
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="subtitle" name="subtitle"
                                ...
                                value="{{ old('subtitle') }}" placeholder="e.g. Discover the places and experiences worth exploring.">
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="number" id="sort_order" name="sort_order" min="0"
                                    class="form-control-styled" value="{{ old('sort_order', 0) }}">
                            </div>
                        ...
                        <div class="form-field">
                            ...
                            <div class="hint">Used in the Journey Stories slider and the category section banner</div>
                        </div>
