{{-- resources/views/admin/destination/index.blade.php --}}
    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ route('admin.destinations.create') }}" class="btn-primary-dash">
                            ...
                            <tr>
                                <td>
                                    @if($destination->image)
                                        <img src="{{ asset('storage/' . $destination->image) }}" class="dest-thumb" alt="{{ $destination->name }}">
                                    @else
                                ...
                                <td>
                                    ...
                                    <div class="dest-location">{{ $destination->short_description }}</div>
                                </td>
                                <td>
                                    <div class="dest-location">
                                        {{ collect([$destination->city?->name, $destination->state?->name, $destination->country?->name])->filter()->implode(', ') }}
                                    </div>
                                </td>
                                <td>
                                    <span class="badge-status badge-{{ $destination->status }}">
                                        {{ ucfirst($destination->status) }}
                                    </span>
                                </td>
                                <td>
                                    {{ $destination->is_featured ? 'Yes' : '—' }}
                                </td>
                                <td>
