...
<div class="main-section">
    ...
    .checkbox-list { max-height: 200px; overflow-y: auto; border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 10px; display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
    ...
    <div class="app-content content container-fluid">
        <div class="cat-page">
            ...
            <div class="cat-page-header">
                ...
                <a href="{{ route('admin.blog.index') }}" class="btn-secondary-dash">
            ...
            <div class="cat-card">
                <form action="{{ route('admin.blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @include('admin.blog._form', ['submitText' => 'Update Blog'])
                </form>
            </div>
