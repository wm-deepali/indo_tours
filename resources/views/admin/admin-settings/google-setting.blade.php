            ...
            <div class="settings-section" id="gs-gtm">
                ...
                <div class="gs-platform-header gtm-header">
                    ...
                    <div>
                        ...
                        <div class="gs-platform-desc">Deploy and manage all your tracking tags from one place — no code
                            deploys needed.</div>
                    </div>
                ...
                <div class="info-banner blue">
                    ...
                    <div>
                        Get your Container ID from <a href="https://tagmanager.google.com" target="_blank"
                            style="color:#0069d9;font-weight:600">tagmanager.google.com</a> → Admin → Container
                        Settings. It looks like <strong>GTM-XXXXXX</strong>.
                    </div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="field-group col-full">
                        ...
                        <span class="field-hint">Only needed if you use GTM Environments (staging/production
                            isolation).</span>
                    </div>
                </div>
...
&lt;!-- End Google Tag Manager --&gt;</pre>
                ...
                <div class="toggle-row">
                    <div>
                        <div class="toggle-info-label">DataLayer — Push enquiry events</div>
                        <div class="toggle-info-sub">Push lead/enquiry submission events into dataLayer automatically.
                        </div>
                    </div>
                    <label class="toggle-switch">
            ...
            <div class="settings-section" id="gs-ga4">
                ...
                <div class="gs-platform-header ga4-header">
                    ...
                    <div>
                        ...
                        <div class="gs-platform-desc">Track traffic, conversions, revenue, and user behaviour across
                            your store.</div>
                    </div>
                    <label class="toggle-switch" style="margin-left:auto;flex-shrink:0">
                ...
                <div class="info-banner amber">
                    ...
                    <div>
                        <strong>Already using GTM?</strong> If GTM is enabled above, add GA4 as a tag inside Tag Manager
                        instead of entering a Measurement ID here — otherwise GA4 will fire twice.
                    </div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="field-group">
                        ...
                        <span class="field-hint">Required for server-side event tracking via Measurement
                            Protocol.</span>
                    </div>
                    <div class="field-group">
                        ...
                        <input type="text" name="ga4_client_id_cookie" class="field-input monospace"
                            ...
                            placeholder="_ga">
                        <span class="field-hint">Cookie that stores the GA4 client ID. Default is
                            <code>_ga</code>.</span>
                    </div>
                </div>

                <p class="settings-section-title" style="margin-top:20px;font-size:13px"><i
                        class="fa-solid fa-bolt"></i> Enhanced E-commerce Events</p>
                <p class="settings-section-desc">Choose which GA4 e-commerce events fire automatically on your store.
                </p>

                <div class="events-grid">
                    @php
                        $ga4Events = [
                            ['key' => 'ga4_ev_view_item', 'label' => 'view_item', 'desc' => 'Destination or package page viewed'],
                            ['key' => 'ga4_ev_view_search_results', 'label' => 'view_search_results', 'desc' => 'Search results viewed'],
                            ['key' => 'ga4_ev_begin_enquiry', 'label' => 'begin_enquiry', 'desc' => 'Enquiry form opened'],
                            ['key' => 'ga4_ev_generate_lead', 'label' => 'generate_lead', 'desc' => 'Enquiry submitted (package/callback/general/popup)'],
                            ['key' => 'ga4_ev_search', 'label' => 'search', 'desc' => 'Site search used'],
                    ...
                    @foreach($ga4Events as $ev)
                        <div class="event-chip">
                            <label class="toggle-switch" style="width:32px;height:18px">
                                <input type="checkbox" name="{{ $ev['key'] }}" {{ old($ev['key'], $google_setting->{$ev['key']} ?? true) ? 'checked' : '' }}>
                                <span class="toggle-track"></span>
                            </label>
                            <div>
            ...
            <div class="settings-section" id="gs-ads">
                ...
                <div class="gs-platform-header"
                    style="background:linear-gradient(135deg,#1a73e820,#1a73e808);border:1px solid #1a73e830;border-radius:var(--radius-sm);padding:16px 20px;display:flex;align-items:center;gap:14px;margin-bottom:20px">
                    ...
                    <div>
                        ...
                        <div class="gs-platform-desc">Track ad conversions and enable remarketing audiences for your
                            campaigns.</div>
                    </div>
                    <label class="toggle-switch" style="margin-left:auto;flex-shrink:0">
                ...
                <div class="form-grid">
                    <div class="field-group">
                        ...
                        <span class="field-hint">Found in Google Ads → Tools → Conversion Tracking → your
                            conversion.</span>
                    </div>
                    <div class="field-group">
                        <label class="field-label">Enquiry Conversion Label <span class="req">*</span></label>
                        <input type="text" name="gads_enquiry_label" class="field-input monospace"
                            value="{{ old('gads_enquiry_label', $google_setting->gads_enquiry_label ?? '') }}"
                            placeholder="AbCdEfGhIj0K">
                        <span class="field-hint">Label for the enquiry-submission conversion action.</span>
                    </div>
                    <div class="field-group">
                    ...
                    <div class="field-group">
                        <label class="field-label">Callback Request Conversion Label</label>
                        <input type="text" name="gads_callback_request_label" class="field-input monospace"
                            value="{{ old('gads_callback_request_label', $google_setting->gads_callback_request_label ?? '') }}"
                            placeholder="AbCdEfGhIj0K">
                    </div>
                    <div class="field-group">
                        ...
                        <span class="field-hint">For Dynamic Remarketing — shows past visitors ads with products they
                            viewed.</span>
                    </div>
                    <div class="field-group">
                        ...
                        <select name="gads_currency" class="field-select">
                            ...
                            @foreach(['INR' => 'INR — Indian Rupee', 'USD' => 'USD — US Dollar', 'EUR' => 'EUR — Euro', 'GBP' => 'GBP — British Pound', 'AED' => 'AED — UAE Dirham'] as $code => $label)
                                <option value="{{ $code }}" {{ $savedCurrency == $code ? 'selected' : '' }}>{{ $label }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="toggle-row" style="margin-top:12px">
                    <div>
                        ...
                        <div class="toggle-info-sub">Send hashed customer data (email, phone) to improve conversion
            ...
            <div class="settings-section" id="gs-search">
                ...
                <div class="form-grid">
                    <div class="field-group col-full">
                        ...
                        <select name="gsc_verify_method" id="gscMethod" class="field-select"
                            onchange="toggleGscMethod(this.value)">
                    ...
                    <div class="field-group col-full gsc-method-field" id="gsc-meta" style="display:none">
                        ...
                        <span class="field-hint">Paste only the <code>content</code> value from the meta tag Google
                            gives you. We inject it automatically.</span>
                        <div class="code-preview-block" style="margin-top:12px">
                            <div class="code-preview-label"><i class="fa-solid fa-code"></i> Auto-injected in
                                &lt;head&gt;</div>
                            <pre
                                class="code-preview">&lt;meta name="google-site-verification" content="<span id="gscMetaPreview">{{ $google_setting->gsc_meta_content ?? 'YOUR_VALUE' }}</span>" /&gt;</pre>
                        </div>
                    </div>
                    ...
                    <div class="col-full gsc-method-field" id="gsc-file" style="display:none">
                        <div class="info-banner amber">
                            <i class="fa-solid fa-triangle-exclamation"></i>
                            <div>
                                HTML File method requires you to manually upload the verification file to your server's
                                root directory. This platform cannot do that automatically. Use the Meta Tag method for
                    ...
                    <div class="col-full gsc-method-field" id="gsc-dns" style="display:none">
                        <div class="info-banner amber">
                            <i class="fa-solid fa-triangle-exclamation"></i>
                            <div>
                                DNS TXT Record must be added via your domain registrar or DNS provider. This platform
                                does not manage DNS records. Copy the TXT value from Google Search Console and add it to
                                your DNS manually.
                            </div>
                        </div>
                    </div>
                ...
                <div class="toggle-row" style="margin-top:4px">
                    <div>
                        ...
                        <div class="toggle-info-sub">Ping Google Search Console with your sitemap URL on every publish.
                        </div>
                    </div>
                    <label class="toggle-switch">
            ...
            <div class="settings-section" id="gs-meta">
                ...
                <div class="gs-platform-header"
                    style="background:linear-gradient(135deg,#0866ff20,#0866ff08);border:1px solid #0866ff30;border-radius:var(--radius-sm);padding:16px 20px;display:flex;align-items:center;gap:14px;margin-bottom:20px">
                    ...
                    <div>
                        ...
                        <div class="gs-platform-desc">Track Facebook / Instagram ad performance, retarget visitors, and
                            build lookalike audiences.</div>
                    </div>
                    <label class="toggle-switch" style="margin-left:auto;flex-shrink:0">
                ...
                <div class="form-grid">
                    ...
                    <div class="field-group">
                        ...
                        <span class="field-hint">Content value for
                            <code>&lt;meta name="facebook-domain-verification"&gt;</code>.</span>
                    </div>
                </div>

                <p class="settings-section-title" style="margin-top:20px;font-size:13px"><i
                        class="fa-solid fa-bolt"></i> Standard Events</p>
                ...
                <div class="events-grid">
                    @php
                        $metaEvents = [
                            ...
                            ['key' => 'meta_ev_view_content', 'label' => 'ViewContent', 'desc' => 'Destination or package page viewed'],
                            ['key' => 'meta_ev_lead', 'label' => 'Lead', 'desc' => 'Package / general / popup enquiry submitted'],
                            ['key' => 'meta_ev_contact', 'label' => 'Contact', 'desc' => 'Callback request or Contact Us submitted'],
                            ['key' => 'meta_ev_complete_reg', 'label' => 'CompleteRegistration', 'desc' => 'New customer registered'],
                            ['key' => 'meta_ev_search', 'label' => 'Search', 'desc' => 'Site search used'],
                        ];
                    @endphp
                ...
                <div class="toggle-row" style="margin-top:16px">
                    <div>
                        ...
                        <div class="toggle-info-sub">Send hashed customer email / phone to improve audience matching on
                            Meta.</div>
                    </div>
                    <label class="toggle-switch">
            ...
            <div class="settings-section" id="gs-other">
                ...
                <p class="settings-section-desc">
                    Paste any third-party script (Hotjar, Clarity, TikTok Pixel, Snapchat, LinkedIn Insight Tag, etc.)
                    directly. Scripts are injected verbatim — wrap in <code>&lt;script&gt;</code> tags where needed.
                </p>

                <div class="info-banner amber" style="margin-bottom:20px">
                    <i class="fa-solid fa-triangle-exclamation"></i>
                    <div>
                        Custom scripts run on every page. A broken script can affect storefront performance. Test
                        thoroughly before saving.
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="field-group col-full">
                        ...
                        <span class="field-hint">Injected just before <code>&lt;/head&gt;</code> on every storefront
                            page.</span>
                    </div>
                    ...
                    <div class="field-group col-full">
                        ...
                        <span class="field-hint">Injected right after <code>&lt;body&gt;</code> opens. Use for GTM
                            noscript fallback if needed.</span>
                    </div>
                    ...
                    <div class="field-group col-full">
                        ...
                        <span class="field-hint">Injected just before <code>&lt;/body&gt;</code> closes. Good for less
                            critical third-party widgets.</span>
                    </div>
                    ...
                    <div class="field-group col-full">
                        ...
                        <span class="field-hint">Clicking a chip inserts a placeholder snippet into the Head Scripts box
                            above — fill in your Pixel/Site ID.</span>
                    </div>
                </div>
    ...
    <div class="action-bar">
        ...
        <a href="{{ route('admin.settings.index', ['tab' => 'tracking']) }}" class="btn-secondary-dash">
            Discard Changes
        </a>
